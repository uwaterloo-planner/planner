...
from fetcher.models import RawCourse, RawClass, ValidClassSchedules
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for course in all_courses:
            ...
            valid_class_schedules = ValidClassSchedules(
                course_id=course_id,
    ...
    def generate_valid_class_schedules(self, class_list):
        ...
        for combination in all_combinations:
            if all(not classes_overlap(class1, class2) for class1, class2 in combinations(combination, 2)):
                filtered_combinations.append([class_data.class_section for class_data in combination])
